...
import com.example.sn_test.Adpater.CalendarAdapter
import java.util.*
import java.util.jar.Attributes
import kotlin.collections.HashSet

public class CalendarView_Custom: LinearLayout {
    ...
    fun updateCalendar(events: HashSet<Date>, inputCalendar: Calendar) {
        ...
        val monthBeginningCell = inputCalendar.get(Calendar.DAY_OF_WEEK) - 1    // 캘린더 헤더의 시작요일에 따라 빼주는 값이 달라짐.
